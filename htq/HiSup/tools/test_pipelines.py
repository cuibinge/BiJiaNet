...
from hisup.utils.visualizer import save_viz
...
class TestPipeline():
    ...
    def test_on_inria(self, model, dataset_name):
        ...
        if not os.path.exists(os.path.join(self.output_dir, 'pol')):
            os.makedirs(os.path.join(self.output_dir, 'pol'))
        ...
        for image_name in tqdm(test_imgs, desc='Total processing'):
            ...
            save_viz(image, polygons, os.path.join(self.output_dir, 'pol'), file_name)
