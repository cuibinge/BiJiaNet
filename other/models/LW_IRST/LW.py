...
class LW_IRST_ablation(nn.Module):
    def __init__(self, n_classes=10, encoder_relu=False, decoder_relu=True, channel=(8, 32, 64), dilations=(2,4,8,16), kernel_size=(3,5,7,9), padding=(1,2,3,4)):
        super().__init__()
        ...
        self.con4to3 = nn.Conv2d(in_channels=4,out_channels=3,kernel_size=1)
