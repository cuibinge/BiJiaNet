...
if __name__ == "__main__":
    image_dir_path_list = [
        r"F:\NET\KDGraph\data\jiaozhouwan\8bit"
    ]

    geojson_dir_path_list = [
        r"F:\NET\KDGraph\data\jiaozhouwan\geojson"
    ]

    rdp_dist = 2
    crop_size = 448
    overlap_size = 0
    save_path = os.path.join("F:\\NET\\KDGraph\\data\\jiaozhouwan\\out", f"CROP_{crop_size}_OVERLAP_{overlap_size}")
