    ...
    def __init__(self, data_name, train=True):
        if data_name == 'isic18':
            ...
            if train:
                ...
                self.mean = 149.8485
                self.std = 35.3346
        elif data_name == 'redtide':
            if train:
                self.mean = [44.73161391, 57.9173625,  68.10317192]
                self.std = [22.60609338, 25.518125,   28.22845986]
            else:
                self.mean = [3.6473826, 3.6473826, 3.6473826]
                self.std = [18.41478743, 18.41478743, 18.41478743]

    def __call__(self, data):
        img, msk = data
        img_normalized = (img - np.array(self.mean)) / np.array(self.std)
